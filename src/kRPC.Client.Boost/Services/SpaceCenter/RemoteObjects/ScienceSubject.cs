...
/// <summary>
/// Obtained by calling <see cref="M:kRPC.Client.Boost.Services.SpaceCenter.RemoteObjects.Experiment.GetScienceSubject" />.
/// </summary>
public class ScienceSubject : RemoteObject
{
    ...
    /// </summary>
    internal ScienceSubject(IConnectionMultiplexer connection, ulong id) : base(connection, id)
    {
    }
